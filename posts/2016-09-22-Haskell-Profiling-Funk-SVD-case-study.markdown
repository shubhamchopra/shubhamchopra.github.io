...
The code for both the initial and optimized version is available [here](www.github.com/shubhamchopra/RecommenderSystem/). To get movie recommendations, you can get data from Netflix or [MovieLens](http://grouplens.org/datasets/movielens/). I am currently using GHC 7.10.3. You might get different numbers depending on the sample of data you use, the processor and such, but the shape/pattern of the charts would likely be similar.
