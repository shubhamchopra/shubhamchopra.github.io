...
For a simple blog, you really don't have to tinker around with the Haskell code base. The whole process is basically about encoding your routing rules, and your compilation rules that will be used to read your posts, convert them to html and then put them in pre-defined templates. The rules are defined in Haskell, and are compiled into a binary called _site_. You can use this binary to build your static site, and even see the site using its _watch_ command. Once you are familiar with this, you are ready to start writing posts.
